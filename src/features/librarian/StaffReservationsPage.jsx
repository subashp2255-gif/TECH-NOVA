...
import { Armchair, Search, Filter, RefreshCw, CheckCircle2, Clock, XCircle, LogOut } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in duration-300 pb-12">
      <div className="flex flex-wrap items-center justify-between gap-4 pb-2 border-b border-slate-200">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-navy tracking-tight">Reservations & Seat Grid</h1>
                    ...
                    <tr key={b.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="p-3.5">
                        <Badge className={`text-[10px] font-bold ${
                          ...
                          b.status === 'cancelled' ? 'bg-red-500 text-white' : 'bg-teal-600 text-white'
                        }`}>
                          {b.status || 'Active'}
                        </Badge>
                      </td>
